...
interface GerenteRelatorioProps {
  ...
  mesas: Mesa[];
  fechamentosMotoboy: any[];
  diferencasCaixa: any[];
  effectiveGerente: { id: string; nome: string; role: string };
}

const GerenteRelatorio = ({
  pinVerificado,
  pinGateUI,
  allFechamentos,
  allEventos,
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex flex-wrap gap-2">
          <Button variant="outline" size="sm" className="gap-1.5 rounded-xl text-xs font-bold" onClick={exportVendasPdf}>
            <FileDown className="h-3.5 w-3.5" />
            Vendas PDF
          </Button>
          <Button variant="outline" size="sm" className="gap-1.5 rounded-xl text-xs font-bold" onClick={exportProdutosPdf}>
            <FileDown className="h-3.5 w-3.5" />
            Produtos PDF
          </Button>
          <Button variant="outline" size="sm" className="gap-1.5 rounded-xl text-xs font-bold" onClick={exportCaixaPdf}>
            <FileDown className="h-3.5 w-3.5" />
            Caixa PDF
          </Button>
        </div>
      ...
      {(() => {
        ...
        const totalDeliverySection = deliveryPedidos.reduce((s, p) => s + p.total, 0) + deliveryFech.reduce((s, f) => s + f.total, 0);
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="rounded-2xl border border-border bg-card p-4">
                ...
                <p className="text-lg font-black tabular-nums text-primary">{formatPrice(totalDeliverySection)}</p>
              </div>
            </div>
...
export default GerenteRelatorio;
