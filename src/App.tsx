  ...
  return (
    <div key={location.pathname} className="route-fade-in">
      ...
      <Routes location={location}>
        ...
        <Route path="/garcom-pdv" element={<ProtectedRoute requiredLevel="operational" requiredModule={["garcom", "garcom_pdv"]}><GarcomPdvPage /></ProtectedRoute>} />
        <Route path="/mesa/:id" element={<ProtectedRoute requiredLevel="operational" requiredModule={["garcom", "garcom_pdv"]}><MesaPage /></ProtectedRoute>} />
